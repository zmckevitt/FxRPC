...
pub trait FxmarkRPC {
    fn rpc_open(&mut self) -> Result<(), RPCError>;
    fn rpc_read(&mut self) -> Result<(), RPCError>;
    fn rpc_pread(&mut self) -> Result<(), RPCError>;
    fn rpc_write(&mut self) -> Result<(), RPCError>;
    fn rpc_pwrite(&mut self) -> Result<(), RPCError>;
    fn rpc_close(&mut self) -> Result<(), RPCError>;
    fn rpc_remove(&mut self) -> Result<(), RPCError>;
    fn rpc_mkdir(&mut self) -> Result<(), RPCError>;
}
